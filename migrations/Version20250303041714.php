 ...
 */
final class Version20250303041714 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD latitude DOUBLE PRECISION DEFAULT NULL, ADD longitude DOUBLE PRECISION DEFAULT NULL, ADD email_auth_enabled TINYINT(1) NOT NULL, ADD email_auth_code VARCHAR(255) DEFAULT NULL, ADD created_at DATETIME NOT NULL, ADD failed_login_attempts INT DEFAULT 0 NOT NULL, ADD lock_until DATETIME DEFAULT NULL, CHANGE telephone telephone VARCHAR(20) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP latitude, DROP longitude, DROP email_auth_enabled, DROP email_auth_code, DROP created_at, DROP failed_login_attempts, DROP lock_until, CHANGE telephone telephone INT NOT NULL');
    }
}
